...
import { getNearbyPOIs } from '../services/location.service';
import { useNotification } from '../context/NotificationContext';
import { formatPrice } from '../utils/format';
import LoadingSpinner from '../components/common/LoadingSpinner';
import HotspotImpactDisplay from '../components/property/HotspotImpactDisplay';
          ...
          <div className="prediction-results">
            {isLoading ? (
              ...
              <div className="prediction-data">
                ...
                {prediction && nearbyPOIs.length > 0 && (
                  <HotspotImpactDisplay 
                    pois={nearbyPOIs} 
                    basePrice={prediction.currentPricePrediction}
                    priceImpacts={{
                      transit: prediction.locationFactors?.transitImpact || 0,
                      education: prediction.locationFactors?.educationImpact || 0,
                      shopping: prediction.locationFactors?.shoppingImpact || 0,
                      healthcare: prediction.locationFactors?.healthcareImpact || 0,
                      recreation: prediction.locationFactors?.recreationImpact || 0
                    }}
                  />
                )}
